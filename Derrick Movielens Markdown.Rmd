...
The dataset will now be split into a train set (edx) which we will use to train, develop and select our algorithim and a test set (validation) to test the performance of the algorithm. The test set will be 10% of the dataset.
