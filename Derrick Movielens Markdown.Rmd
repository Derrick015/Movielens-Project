...
To achieve the aim of this project we will first import the data, performe some exploratory data analysis and finally compare four different models and determine the best one with the lowest RMSE.
