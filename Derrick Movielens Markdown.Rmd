...
In the future, it would be intersting to explore how the genre effect may affect model performance. The ensemble method which combines several models can also be employed to improve our model.
