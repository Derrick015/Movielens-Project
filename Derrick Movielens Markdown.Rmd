...
average rating by movie in the edx dataset
```{r}
...
number of ratings by movie in the edx dataset
```{r}
edx %>% 
  count(movieId) %>% 
  ggplot(aes(n)) + 
  geom_histogram( bins=30, color = I("black")) +
  scale_x_log10() +
  labs(x = "Number of Movies", y = "Number of ratings", caption = "Source: edx dataset")
 ```
...
edx %>% 
  ...
  geom_histogram( bins=30, color = I("black")) +
  scale_x_log10() +
  labs(x = "Users", y = "Number of ratings", caption = "Source: edx dataset") 
