...
By adding the computed $b_{i}$ to $\mu$ and thus capturing the movie effect.However, there is still more we can do to make the recommender system even better.
